...
int parse_class(struct char_data *ch, char arg)
{
  ...
  switch (arg) {
  case '1': class = CLASS_MAGIC_USER; break;
  case '2': class = CLASS_CLERIC; break;
  case '3': class = CLASS_THIEF; break;
  case '4': class = CLASS_WARRIOR; break;
...
/* Kortaal */
  { CLASS_MAGIC_USER,	3017,	SCMD_EAST	},
...
void roll_real_abils(struct char_data *ch)
{
  ...
  SET_SKILL(ch, SKILL_WP_UNARMED, (GET_STR(ch) + GET_DEX(ch)));
...
void do_start(struct char_data *ch)
{
  ...
  case RACE_HUMAN:
    ...
    break;
  case RACE_ELF:
    SET_SKILL(ch, SKILL_LANG_COMMON, 90);
    SET_SKILL(ch, SKILL_LANG_ELVEN, 100);
    break;
  case RACE_GNOME:
    SET_SKILL(ch, SKILL_LANG_COMMON, 75);
    SET_SKILL(ch, SKILL_LANG_GNOME, 100);
    break;
  case RACE_DWARF:
    ...
    break;
  default:
    SET_SKILL(ch, SKILL_LANG_COMMON, GET_INT(ch) + GET_WIS(ch));
    break;
  }
  ...
  case CLASS_MAGIC_USER:
    SET_SKILL(ch, SKILL_WP_DAGGER, (GET_STR(ch) + GET_DEX(ch)));
    break;

  case CLASS_CLERIC:
    SET_SKILL(ch, SKILL_WP_MACE, (GET_STR(ch) + GET_DEX(ch)));
    break;
  ...
  case CLASS_WARRIOR:
    SET_SKILL(ch, SKILL_WP_POLEARM, (GET_STR(ch) + GET_DEX(ch)));
    break;
  }
...
void advance_level(struct char_data *ch)
{
  ...
  case CLASS_THIEF:
    add_hp += rand_number(1, 6);
    add_mana = 0;
    add_move = rand_number(1, 3);
    break;

  case CLASS_WARRIOR:
    add_hp += rand_number(1, 10);
    add_mana = 0;
    add_move = rand_number(1, 3);
    break;
  }
...
void init_spell_race_levels(void)
{
  /* Human */
  spell_race_level(SKILL_LANG_COMMON, RACE_HUMAN, 1);
  /* Elf */
  spell_race_level(SKILL_LANG_COMMON, RACE_ELF, 1);
  spell_race_level(SKILL_LANG_ELVEN, RACE_ELF, 1);
  /* Gnome */
  spell_race_level(SKILL_LANG_COMMON, RACE_GNOME, 1);
  spell_race_level(SKILL_LANG_GNOME, RACE_GNOME, 1);
  /* Dwarf */
...
void init_spell_levels(void)
{
  ...
  spell_level(SKILL_WP_UNARMED, CLASS_MAGIC_USER, 1);
  ...
  spell_level(SKILL_WP_DAGGER, CLASS_MAGIC_USER, 2);
  spell_level(SPELL_ARMOR, CLASS_MAGIC_USER, 2);
  spell_level(SPELL_SHOCKING_GRASP, CLASS_MAGIC_USER, 2);
  spell_level(SPELL_SLEEP, CLASS_MAGIC_USER, 2);
  spell_level(SPELL_DETECT_INVIS, CLASS_MAGIC_USER, 3);
  spell_level(SPELL_MAGIC_MISSILE, CLASS_MAGIC_USER, 3);
  spell_level(SPELL_STRENGTH, CLASS_MAGIC_USER, 3);
  spell_level(SPELL_DETECT_ALIGN, CLASS_MAGIC_USER, 3);
  spell_level(SPELL_CHARM, CLASS_MAGIC_USER, 4);
  spell_level(SPELL_INFRAVISION, CLASS_MAGIC_USER, 4);
  spell_level(SKILL_WP_MACE, CLASS_MAGIC_USER, 6);
  spell_level(SPELL_LOCATE_OBJECT, CLASS_MAGIC_USER, 6);
  spell_level(SPELL_LIGHTNING_BOLT, CLASS_MAGIC_USER, 6);
  spell_level(SPELL_BLINDNESS, CLASS_MAGIC_USER, 6);
  spell_level(SPELL_INVISIBLE, CLASS_MAGIC_USER, 8);
  spell_level(SPELL_FIREBALL, CLASS_MAGIC_USER, 9);
  spell_level(SPELL_REMOVE_CURSE, CLASS_MAGIC_USER, 9);
  spell_level(SPELL_CONTROL_WEATHER, CLASS_MAGIC_USER, 13);
  spell_level(SPELL_WATERWALK, CLASS_MAGIC_USER, 13);
  spell_level(SPELL_PORTAL, CLASS_MAGIC_USER, 13);
  spell_level(SPELL_ENCHANT_WEAPON, CLASS_MAGIC_USER, 15);
  spell_level(SPELL_ENERGY_DRAIN, CLASS_MAGIC_USER, 18);

  /* CLERICS */
  spell_level(SKILL_WP_MACE, CLASS_CLERIC, 1);
  spell_level(SPELL_BLESS, CLASS_CLERIC, 1);
  spell_level(SKILL_WP_UNARMED, CLASS_CLERIC, 1);
  spell_level(SPELL_CAUSE_LIGHT, CLASS_CLERIC, 1);
  ...
  spell_level(SKILL_TURNING, CLASS_CLERIC, 1);
  spell_level(SPELL_DETECT_MAGIC, CLASS_CLERIC, 1);
  spell_level(SKILL_WP_HAMMER, CLASS_CLERIC, 2);
  spell_level(SPELL_CREATE_FOOD, CLASS_CLERIC, 3);
  spell_level(SPELL_DETECT_INVIS, CLASS_CLERIC, 3);
  spell_level(SKILL_WP_STAFF, CLASS_CLERIC, 4);
  spell_level(SPELL_CURE_BLIND, CLASS_CLERIC, 5);
  spell_level(SPELL_LOCATE_OBJECT, CLASS_CLERIC, 5);
  spell_level(SPELL_REMOVE_CURSE, CLASS_CLERIC, 5);
  spell_level(SPELL_CALL_LIGHTNING, CLASS_CLERIC, 5);
  spell_level(SKILL_WP_FLAIL, CLASS_CLERIC, 6);
  spell_level(SPELL_POISON, CLASS_CLERIC, 7);
  spell_level(SPELL_REMOVE_POISON, CLASS_CLERIC, 7);
  spell_level(SKILL_WP_STAFF, CLASS_CLERIC, 8);
  spell_level(SPELL_CAUSE_CRITIC, CLASS_CLERIC, 9);
  spell_level(SKILL_WP_WHIP, CLASS_CLERIC, 9);
  spell_level(SPELL_CURE_CRITIC, CLASS_CLERIC, 9);
  spell_level(SPELL_DISPEL_EVIL, CLASS_CLERIC, 9);
  spell_level(SPELL_DISPEL_GOOD, CLASS_CLERIC, 9);
  spell_level(SPELL_WATERWALK, CLASS_CLERIC, 9);
  spell_level(SPELL_WORD_OF_RECALL, CLASS_CLERIC, 11);
  spell_level(SPELL_HEAL, CLASS_CLERIC, 11);
  spell_level(SPELL_HARM, CLASS_CLERIC, 11);
  spell_level(SPELL_CONTROL_WEATHER, CLASS_CLERIC, 14);

  /* THIEVES */
  spell_level(SKILL_WP_DAGGER, CLASS_THIEF, 1);
  spell_level(SKILL_WP_UNARMED, CLASS_THIEF, 1);
  ...
  spell_level(SKILL_WP_SWORD_SHORT, CLASS_THIEF, 2);
  ...
  spell_level(SKILL_WP_SPEAR, CLASS_THIEF, 7);
  spell_level(SKILL_WP_WHIP, CLASS_THIEF, 8);
  spell_level(SKILL_WP_FLAIL, CLASS_THIEF, 9);

  /* WARRIORS */
  spell_level(SKILL_WP_DAGGER, CLASS_WARRIOR, 1);
  spell_level(SKILL_WP_POLEARM, CLASS_WARRIOR, 1);
  spell_level(SKILL_WP_UNARMED, CLASS_WARRIOR, 1);
  spell_level(SKILL_KICK, CLASS_WARRIOR, 1);
  spell_level(SKILL_RESCUE, CLASS_WARRIOR, 1);
  spell_level(SKILL_BASH, CLASS_WARRIOR, 1);
  spell_level(SKILL_WP_MACE, CLASS_WARRIOR, 2);
  spell_level(SKILL_WP_SWORD_SHORT, CLASS_WARRIOR, 2);
  spell_level(SKILL_WP_FLAIL, CLASS_WARRIOR, 3);
  spell_level(SKILL_WP_STAFF, CLASS_WARRIOR, 3);
  spell_level(SKILL_WP_SPEAR, CLASS_WARRIOR, 4);
  spell_level(SKILL_WP_HAMMER, CLASS_WARRIOR, 4);
  spell_level(SKILL_WP_SWORD_LONG, CLASS_WARRIOR, 5);
  spell_level(SKILL_WP_AXE, CLASS_WARRIOR, 5);
  spell_level(SKILL_WP_SWORD_TWOHANDED, CLASS_WARRIOR, 6);
  spell_level(SKILL_WP_WHIP, CLASS_WARRIOR, 6);

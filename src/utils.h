...
#define GET_TLEVEL(ch)	((ch)->player_specials->saved.tlevel)
...
#define GET_MSKILL(ch, i)   ((ch)->mob_specials.mskills[i])
#define SET_MSKILL(ch, i, pct)  ((ch)->mob_specials.mskills[i] = pct)

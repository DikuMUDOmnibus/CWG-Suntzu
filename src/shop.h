...
#define TRADE_NOHALF_ELF        (1 << 11)
#define TRADE_NOHALFLING        (1 << 12)
#define TRADE_NODROW_ELF        (1 << 13)
#define TRADE_NOANIMAL          (1 << 14)
#define TRADE_NOCONSTRUCT       (1 << 15)
#define TRADE_NODEMON           (1 << 16)
#define TRADE_NODRAGON      	(1 << 17)
#define TRADE_NOFISH            (1 << 18)
#define TRADE_NOGIANT       	(1 << 19)
#define TRADE_NOGOBLIN      	(1 << 20)
#define TRADE_NOINSECT      	(1 << 21)
#define TRADE_NOORC         	(1 << 22)
#define TRADE_NOSNAKE       	(1 << 23)
#define TRADE_NOTROLL       	(1 << 24)
#define TRADE_NOHALF_ORC    	(1 << 25)
#define TRADE_NOMINOTAUR    	(1 << 26)
#define TRADE_NOKOBOLD      	(1 << 27)
#define TRADE_NOMINDFLAYER  	(1 << 28)
